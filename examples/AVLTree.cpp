 ...
 * @brief Example file for the AVLTree class
 * @version 1.0
 * @date 2023-01-17
 * 
...
int main() {
    std::cout << "Test della classe AVLTree" << std::endl;

    AVLTree<comparator> tree = AVLTree<comparator>();
    ...
    std::cout << "Stampa albero - rimosso il 1" << std::endl;
    tree.prettyPrint();
